...
df = pd.read_csv("static/data/winequality-white.csv", sep =";")
...
def index():
    ...
    if request.method == 'POST':
        ...
        #filter input data with row-number (check indexes!)
        filter_data = x_data[selected]
        #start instance two
        inst_2 = AutoEncoder()#VAE()
        inst_2.get_data(filter_data)        
        inst_2.train()
        ...
        """)
            ...
            # projection
        projection_data = inst_2.projection(x_data)
